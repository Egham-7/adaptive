        ...
        const upsertResults = await Promise.all(
          messagesData.map((messageData) => {
            const createData = {
              ...
              metadata: messageData.metadata ? JSON.parse(JSON.stringify(messageData.metadata)) : null,
              annotations: messageData.annotations ? JSON.parse(JSON.stringify(messageData.annotations)) : null,
