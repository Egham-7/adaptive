    ...
    <SignedOut>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 items-start"
        >
                ...
                <div className="space-y-4 flex-grow">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary to-primary/60 opacity-20 animate-pulse" />
                    </div>
