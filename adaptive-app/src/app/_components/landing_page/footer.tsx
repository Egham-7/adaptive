          ...
          <div className="order-first flex flex-wrap justify-center gap-6 text-sm md:order-last">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <title>X (formerly Twitter) logo</title> {/* Added title */}
                <path
                  fill="currentColor"
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <title>LinkedIn logo</title> {/* Added title */}
                <path
                  fill="currentColor"
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <title>GitHub logo</title> {/* Added title */}
                <path
                  fill="currentColor"
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <title>Discord logo</title> {/* Added title */}
                <path
                  fill="currentColor"
