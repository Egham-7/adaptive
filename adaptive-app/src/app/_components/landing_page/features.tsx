                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <p className="mt-2 text-center text-muted-foreground">
                                    Choose the optimal AI model for each query in milliseconds with our intelligent
                                    routing system.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="before:-inset-2 relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:rounded-full before:border dark:border-white/10 dark:before:border-white/5 items-center justify-center">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">
                                        Automatic failover to alternative providers ensures your applications stay
                                        online even when individual AI services go down.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="font-medium text-lg transition">Universal Provider Support</h2>
                                    <p className="text-foreground">
                                        Connect to OpenAI, Anthropic, Google, Meta, and more through a single unified
                                        API with seamless provider switching.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-foreground">
                                            Optimize performance with intelligent caching, request batching, and
                                            model-specific optimizations for maximum efficiency.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="font-medium text-lg transition">Smart Analytics & Learning</h2>
                                        <p className="text-foreground">
                                            Continuously improve model selection through online learning based on evals
                                            and customer feedback, with full observability into routing decisions.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">
                                        Built with transparency in mind. Our routing algorithms and infrastructure are
                                        open source, giving you full visibility and control.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
