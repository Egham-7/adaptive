...
const PromptCircle = forwardRef<HTMLDivElement, { className?: string }>(({ className }, ref) => (
    <div
        ref={ref}
        className={cn(
...
const AdaptiveCircle = forwardRef<HTMLDivElement, { className?: string }>(({ className }, ref) => (
    <div
        ref={ref}
        className={cn(
...
export default function HeroSection() {
    ...
    const rotatingTexts = ["Smart Model Routing", "Tailored AI", "Intelligent Model Selection"];
                ...
                <div className="mx-auto max-w-7xl px-6">
                    <div className="max-w-4xl text-center sm:mx-auto lg:mt-0 lg:mr-auto lg:w-full">
                        ...
                        <p className="mx-auto mt-8 max-w-3xl text-balance text-muted-foreground">
                            Adaptive intelligently routes your queries to the best AI model for each task. Get optimal
                            results while reducing costs by up to 90% compared to using premium models for everything.
                        </p>
