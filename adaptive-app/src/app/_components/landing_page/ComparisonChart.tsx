...
export default function ComparisonChart() {
  ...
  return (
    <div
      ref={chartRef}
      className={`transition-all duration-700 w-full ${animatedProgress > 0 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
    >
      <Card className="p-6 w-full shadow-xl">
        <h4 className="font-semibold text-xl mb-4">Cost & Quality Comparison</h4>
