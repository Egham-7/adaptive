    ...
    <section className="overflow-hidden py-16 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-2xl space-y-6 text-center">
          <h1 className="text-balance font-display text-4xl font-semibold text-center lg:text-5xl">
        ...
        <div className="mt-8 grid gap-6 md:mt-20 md:grid-cols-3">
          ...
          <Card className="relative">
            <span className="absolute inset-x-0 -top-3 mx-auto flex h-6 w-fit items-center rounded-full bg-[linear-gradient(to_right,var(--color-primary),var(--color-secondary))] px-3 py-1 text-xs font-medium text-primary-foreground ring-1 ring-inset ring-white/20 ring-offset-1 ring-offset-gray-950/5">
              Popular
            </span>
            <CardHeader>
              ...
              <Button
                asChild
                className="mt-4 w-full font-medium shadow-subtle transition-opacity hover:opacity-90 bg-primary text-primary-foreground"
              >
                <SignUpButton>
                  <Button>
        ...
        <div className="mx-auto mt-16 max-w-3xl">
          <div className="rounded-lg border bg-muted/30 p-6">
            <h3 className="mb-4 text-lg font-medium">Volume Discounts</h3>
