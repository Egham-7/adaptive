      ...
      <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
          ...
          <div className="relative mt-6 sm:mt-0">
            <div className="aspect-67/34 relative rounded-2xl bg-[linear-gradient(to_bottom,var(--color-input),transparent)] p-px dark:bg-[linear-gradient(to_bottom,var(--color-card),transparent)]">
              <Image
