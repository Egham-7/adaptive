...
import { ChevronDown, Menu, X, Book, Github } from "lucide-react";
...
const iconMenuItems = [
    { name: "Docs", href: "https://docs.adaptive.dev", icon: Book, external: true },
    { name: "GitHub", href: "https://github.com/Egham-7/adaptive", icon: Github, external: true },
];
