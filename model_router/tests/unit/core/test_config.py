...
class TestSettings:
    ...
    # def test_env_var_substitution_edge_cases(self) -> None:
    ...
    # def test_partial_yaml_config(self) -> None:
...
class TestGetSettings:
    ...
    # def test_get_settings_with_env_config_file(self, mock_env_vars, isolated_cache) -> None:
    ...
    # def test_get_settings_with_explicit_config(self) -> None:
