...
from adaptive_ai.utils.yaml_converter import normalize_model_name, yaml_to_model_capability
    ...
    def _load_provider_yaml(self, yaml_file: Path, provider_name: str) -> int:
        ...
        try:
            ...
            for yaml_key, model_data in models_section.items():
                try:
                    model_capability = yaml_to_model_capability(model_data, provider_name)
