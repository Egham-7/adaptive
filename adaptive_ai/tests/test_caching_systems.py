...
class TestProtocolManagerCaching:
    ...
    def test_protocol_decision_caching(self):
        ...
        decision3 = manager._should_use_standard_protocol(
            classification_result, 5000, None
        )
    ...
    def test_cache_eviction_policy(self):
        ...
        # Cache should be bounded
        stats = manager.cache_stats
        assert stats["protocol_decision_cache"]["size"] <= stats["protocol_decision_cache"]["max_size"]
...
class TestModelSelectorCaching:
    ...
    def test_token_bucketing_consistency(self):
        ...
        for token_count, expected_bucket in test_cases:
            ...
            assert bucket == expected_bucket, f"Token {token_count} should bucket to {expected_bucket}, got {bucket}"
...
class TestCachingPerformance:
    ...
    def test_cache_performance_under_load(self):
        ...
        assert cache_hit_time < cache_miss_time, "Cache hits should be faster than misses"
    ...
    def test_concurrent_cache_access_performance(self):
        ...
        def cache_worker():
            ...
            for i in range(20):
                ...
                decision = manager._should_use_standard_protocol(mock_result, 1000 + i, None)
        ...
        assert execution_time < 10.0, f"Concurrent access took too long: {execution_time}s"
