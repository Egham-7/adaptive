...
class TestModelCapability:
    ...
    def test_minimal_model_capability(self):
    ...
    def test_full_model_capability(self):
...
class TestModelSelectionRequest:
    ...
    def test_cost_bias_validation(self):
...
class TestModelSelectionResponse:
    ...
    def test_response_with_alternatives(self):
...
class TestModelSerialization:
    ...
    def test_model_capability_json_serialization(self):
