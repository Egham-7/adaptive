...
from adaptive_ai.services.model_registry import ModelRegistry, model_registry
...
class TestModelRegistry:
    ...
    def test_get_model_capability_existing(self):
    ...
    def test_find_models_matching_criteria(self):
        ...
        assert len(models) >= 1
        for model in models:
            assert model.cost_per_1m_input_tokens <= 5.0

    def test_find_models_with_function_calling(self):
    ...
    def test_find_models_by_complexity(self):
