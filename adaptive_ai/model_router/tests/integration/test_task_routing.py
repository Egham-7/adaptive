...
class TestTaskTypeSpecialization:
    ...
    def test_open_qa_routing(self, base_url: str) -> None:
    ...
    def test_closed_qa_routing(self, base_url: str) -> None:
    ...
    def test_summarization_routing(self, base_url: str) -> None:
    ...
    def test_text_generation_routing(self, base_url: str) -> None:
    ...
    def test_code_generation_routing_specialization(self, base_url: str) -> None:
    ...
    def test_chatbot_routing_efficiency(self, base_url: str) -> None:
    ...
    def test_classification_routing(self, base_url: str) -> None:
    ...
    def test_rewrite_routing(self, base_url: str) -> None:
    ...
    def test_brainstorming_routing(self, base_url: str) -> None:
    ...
    def test_extraction_routing(self, base_url: str) -> None:
...
class TestProviderConstraints:
    ...
    def test_all_major_providers(self, base_url: str) -> None:
    ...
    def test_provider_cost_optimization(self, base_url: str) -> None:
    ...
    def test_context_length_constraints(self, base_url: str) -> None:
    ...
    def test_function_calling_constraints(self, base_url: str) -> None:
...
class TestComplexRoutingScenarios:
    ...
    def test_multi_constraint_routing(self, base_url: str) -> None:
    ...
    def test_reasoning_vs_code_specialization(self, base_url: str) -> None:
    ...
    def test_creative_vs_analytical_routing(self, base_url: str) -> None:
...
class TestTaskComplexityRouting:
    ...
    def test_simple_vs_complex_task_routing(self, base_url: str) -> None:
    ...
    def test_mathematical_reasoning_complexity(self, base_url: str) -> None:
