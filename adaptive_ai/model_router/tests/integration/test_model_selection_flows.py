"""Task specialization and routing tests for @model_router/ model selection."""
...
class TestTaskSpecializationRouting:
    ...
    def test_code_vs_chat_specialization(self, base_url: str) -> None:
    ...
    def test_creative_writing_routing(self, base_url: str) -> None:
    ...
    def test_analysis_routing(self, base_url: str) -> None:
    ...
    def test_task_type_routing_intelligence(self, base_url: str) -> None:
    ...
    def test_reasoning_task_routing(self, base_url: str) -> None:
    ...
    def test_simple_chat_routing(self, base_url: str) -> None:
    ...
    def test_analysis_task_routing(self, base_url: str) -> None:
    ...
    def test_task_specialization_routing(self, base_url: str) -> None:
