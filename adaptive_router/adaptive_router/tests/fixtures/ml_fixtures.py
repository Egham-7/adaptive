...
@pytest.fixture
def mock_classification_model() -> Mock:
...
@pytest.fixture
def mock_prompt_classifier() -> Mock:
...
@pytest.fixture
def classification_test_prompts() -> dict[str, str]:
