...
Fallback is **enabled by default** with race mode for maximum reliability. You can customize or disable it as needed.
...
const completion = await openai.chat.completions.create({
  ...
  // No fallback configuration = enabled with race mode
});
```
