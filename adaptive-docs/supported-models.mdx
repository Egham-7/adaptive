...
<Tabs>
  <Tab title="Ultra Budget">
    ...
    **Models**: GPT-5-nano, DeepSeek-Chat, GPT-4.1-nano, Grok-3-mini, Groq Llama models
  ...
  <Tab title="Budget">
    ...
    **Models**: GPT-5-mini, Claude 3.5 Haiku, GPT-4.1-mini

    **Typical Cost**: $2.00-15.00 per 1M tokens
  </Tab>

  <Tab title="Premium">
    **Best for**: Complex analysis, advanced reasoning, high-quality output

    **Models**: GPT-5, GPT-4o, Claude Sonnet 4, Grok-3

    **Typical Cost**: $10.00-60.00 per 1M tokens
  </Tab>
