...
<div style="background: linear-gradient(135deg, #f0f8ff 0%, #e6f7ff 100%); padding: 1.5rem; border-radius: 8px; margin: 1rem 0;">
  <div style="font-size: 1.2rem; font-weight: bold; color: #1890ff; margin-bottom: 0.5rem;">
    💡 Quick Start
  </div>
  <div style="color: #666;">
    Same as OpenAI API, but use <code>model: ""</code> for intelligent routing and automatic cost savings
  </div>
</div>
...
<Accordion title="🔧 Custom Providers & Enterprise Features">
...
<div style="background: linear-gradient(135deg, #f6ffed 0%, #f0f9e8 100%); padding: 1.5rem; border-radius: 8px; margin: 1.5rem 0; border-left: 4px solid #52c41a;">
  <div style="font-size: 1.1rem; font-weight: bold; color: #389e0d; margin-bottom: 0.5rem;">
    💡 Try These Examples
  </div>
  <div style="color: #666;">
    Copy-paste ready code that works immediately. Each example shows the cost savings in action.
  </div>
</div>

### 1. Simple Chat → 97% Cost Savings

<div style="background: #fff2e8; padding: 1rem; border-radius: 6px; margin: 0.5rem 0; border-left: 3px solid #fa8c16;">
  <strong>Cost Comparison:</strong> Simple question routes to Gemini Flash
  <br />
  <span style="color: #d4380d;">OpenAI Direct:</span> $3.00 per 1M tokens
  <br />
  <span style="color: #389e0d;">Adaptive Smart:</span> $0.10 per 1M tokens
  <br />
  <strong>Savings: 97%</strong>
</div>
...
<div style="background: #fff2e8; padding: 1rem; border-radius: 6px; margin: 0.5rem 0; border-left: 3px solid #fa8c16;">
  <strong>Cost Comparison:</strong> Complex task routes to DeepSeek Reasoner
  <br />
  <span style="color: #d4380d;">OpenAI Direct:</span> $15.00 per 1M tokens
  <br />
  <span style="color: #389e0d;">Adaptive Smart:</span> $2.19 per 1M tokens
  <br />
  <strong>Savings: 85%</strong>
</div>
...
<div style="background: #fff7e6; padding: 1.5rem; border-radius: 8px; margin: 1.5rem 0; border-left: 4px solid #faad14;">
  <div style="font-size: 1.1rem; font-weight: bold; color: #d48806; margin-bottom: 0.5rem;">
    🛠️ Quick Fix Guide
  </div>
  <div style="color: #666;">
    Most issues have simple solutions. Here's how to resolve them fast.
  </div>
</div>
...
2. **Verify your key**: Copy-paste from [llmadaptive.uk](https://llmadaptive.uk) dashboard
...
<Accordion title="⏱️ Rate Limited (429)">
...
3. **Upgrade your plan** at [llmadaptive.uk](https://llmadaptive.uk) for higher limits
...
<Accordion title="🔧 Custom Provider Issues">
...
2. **Model definition must include all fields**:
   ...
   models: [{
     ...
     supports_function_calling: false,           // ✅ Required
...
<div style="background: #fff1f0; padding: 1rem; border-radius: 6px; border-left: 3px solid #ff4d4f;">
  <strong>Service Down?</strong>
  <br />
  1. Check our status page: <a href="https://status.llmadaptive.uk">status.llmadaptive.uk</a>
  <br />
  2. Join our Discord: <a href="https://discord.gg/adaptive">discord.gg/adaptive</a>
  <br />
  3. Email support: support@llmadaptive.uk
</div>
