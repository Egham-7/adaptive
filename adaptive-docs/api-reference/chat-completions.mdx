...
<div style={{background: 'linear-gradient(135deg, #f0f8ff 0%, #e6f7ff 100%)', padding: '1.5rem', borderRadius: '8px', margin: '1rem 0'}}>
...
<div style={{background: 'linear-gradient(135deg, #f6ffed 0%, #f0f9e8 100%)', padding: '1.5rem', borderRadius: '8px', margin: '1.5rem 0', borderLeft: '4px solid #52c41a'}}>
  <div style={{fontSize: '1.1rem', fontWeight: 'bold', color: '#389e0d', marginBottom: '0.5rem'}}>
    💡 Try These Examples
  </div>
  <div style={{color: '#666'}}>
...
<div style={{background: '#fff2e8', padding: '1rem', borderRadius: '6px', margin: '0.5rem 0', borderLeft: '3px solid #fa8c16'}}>
...
<div style={{background: '#fff7e6', padding: '1.5rem', borderRadius: '8px', margin: '1.5rem 0', borderLeft: '4px solid #faad14'}}>
  <div style={{fontSize: '1.1rem', fontWeight: 'bold', color: '#d48806', marginBottom: '0.5rem'}}>
    🛠️ Quick Fix Guide
  </div>
  <div style={{color: '#666'}}>
...
<div style={{background: '#fff1f0', padding: '1rem', borderRadius: '6px', borderLeft: '3px solid #ff4d4f'}}>
