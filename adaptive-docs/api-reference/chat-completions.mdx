...
<ParamField body="prompt_cache_config" type="object">
...
<ParamField body="fallback_mode" type="string">
  Strategy for handling provider failures. Must be one of: `"sequential"`, `"parallel"`
</ParamField>
