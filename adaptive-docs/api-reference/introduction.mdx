...
### Intelligent Routing
Configure model selection with protocol manager:
...
<Card title="Chat Completions" icon="message" href="/api-reference/chat-completions">
  OpenAI-compatible completions with intelligent routing
</Card>
<Card title="Select Model" icon="brain" href="/api-reference/select-model">
  Get intelligent model selection for your own inference
</Card>
</CardGroup>

## Getting Started

1. **Get an API key** from [llmadaptive.uk](https://llmadaptive.uk)
