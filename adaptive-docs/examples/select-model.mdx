...
const response = await fetch("https://llmadaptive.com/api/v1/select-model", {
  method: "POST",
  headers: {
...
response = requests.post(
    "https://llmadaptive.com/api/v1/select-model",
    headers={
        "X-Stainless-API-Key": "your-adaptive-api-key",
        "Content-Type": "application/json"
    },
...
```bash cURL
curl -X POST "https://llmadaptive.com/api/v1/select-model" \
...
const performanceResponse = await fetch("https://llmadaptive.com/api/v1/select-model", {
  method: "POST",
  headers: {
    "X-Stainless-API-Key": "your-adaptive-api-key",
    "Content-Type": "application/json",
...
const costResponse = await fetch("https://llmadaptive.com/api/v1/select-model", {
  method: "POST",
  headers: {
    "X-Stainless-API-Key": "your-adaptive-api-key",
    "Content-Type": "application/json",
...
const functionResponse = await fetch("https://llmadaptive.com/api/v1/select-model", {
  method: "POST",
  headers: {
    "X-Stainless-API-Key": "your-adaptive-api-key",
    "Content-Type": "application/json",
...
const customResponse = await fetch("https://llmadaptive.com/api/v1/select-model", {
  method: "POST",
  headers: {
    "X-Stainless-API-Key": "your-adaptive-api-key",
    "Content-Type": "application/json",
