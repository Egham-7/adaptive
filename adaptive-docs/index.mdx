...
<img
  ...
  alt="Adaptive - Intelligent LLM Gateway"
/>
<img
...
<CardGroup cols={2}>
  <Card
    ...
    href="/quickstart"
  >
    **5-minute setup:** Just change your base URL. Works with OpenAI SDK, Vercel AI SDK, LangChain, and any HTTP client.
  </Card>
  <Card
    title="Smart Model Selection"
    href="/features/intelligent-routing"
  >
    **AI-powered routing:** Automatically chooses the best model for each request based on content, cost, and performance.
  </Card>
  <Card
    title="Massive Cost Savings"
    href="/features/cost-optimization"
  >
    **Up to 80% cheaper:** Route simple tasks to efficient models, complex tasks to premium models.
  </Card>
  <Card
    title="Multi-Provider Access"
    href="/features/provider-constraints"
  >
    **6+ AI providers:** OpenAI, Anthropic, Google, Groq, DeepSeek, and Grok through one unified API.
  </Card>
</CardGroup>
