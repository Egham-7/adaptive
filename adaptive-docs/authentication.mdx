...
<Steps>
  <Step title="Create Account">
    Sign up for free at [llmadaptive.uk](https://llmadaptive.uk) - no credit card required
  </Step>
...
func main() {
    client := openai.NewClient(
        ...
        option.WithBaseURL("https://llmadaptive.uk/api/v1"),
    )
...
$response = $client->post('https://llmadaptive.uk/api/v1/chat/completions', [
    'headers' => [
