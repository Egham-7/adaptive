...
<div style={{textAlign: 'center', margin: '2rem 0', padding: '1.5rem', border: '2px solid #d4af37', borderRadius: '8px', background: 'linear-gradient(135deg, #fdf6e3 0%, #f7f1d3 100%)'}}>
  <div style={{fontSize: '1.8rem', fontWeight: 'bold', color: '#d4af37', marginBottom: '0.5rem'}}>
