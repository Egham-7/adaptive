...
```bash cURL
curl https://llmadaptive.uk/api/v1/messages \
  -H "Content-Type: application/json" \
...
<Steps>
  ...
  <Step title="Monitor Dashboard">
    View request logs and analytics in your [Adaptive dashboard](https://llmadaptive.uk/dashboard)
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Support" href="https://llmadaptive.uk/support" icon="life-ring">
