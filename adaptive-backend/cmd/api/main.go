...
func setupMiddleware(app *fiber.App, allowedOrigins string) {
	...
	app.Use(cors.New(cors.Config{
		...
		AllowHeaders:     "Origin, Content-Type, Accept, Authorization, User-Agent, X-Stainless-Arch, X-Stainless-OS, X-Stainless-Device, X-Stainless-Client, X-Stainless-User, X-Stainless-API-Key",
