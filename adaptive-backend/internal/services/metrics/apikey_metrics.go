...
var (
	apiKeyMetricsInstance *APIKeyMetrics
	apiKeyMetricsOnce     sync.Once
)

// GetAPIKeyMetrics returns the singleton instance of APIKeyMetrics
func GetAPIKeyMetrics() *APIKeyMetrics {
	apiKeyMetricsOnce.Do(func() {
		apiKeyMetricsInstance = &APIKeyMetrics{
	...
	return apiKeyMetricsInstance
}

// NewAPIKeyMetrics is deprecated, use GetAPIKeyMetrics() instead
// Keeping for backward compatibility
func NewAPIKeyMetrics() *APIKeyMetrics {
	return GetAPIKeyMetrics()
}